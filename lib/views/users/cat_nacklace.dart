...
class CatNecklace extends StatefulWidget {
  @override
  _CatNecklaceState createState() => _CatNecklaceState();
}

class _CatNecklaceState extends State<CatNecklace> {
  String uid;
